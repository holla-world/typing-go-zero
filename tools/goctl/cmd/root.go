...
import (
	...
	"github.com/holla-world/typing-go-zero/tools/goctl/api"
	"github.com/holla-world/typing-go-zero/tools/goctl/bug"
	"github.com/holla-world/typing-go-zero/tools/goctl/config"
	"github.com/holla-world/typing-go-zero/tools/goctl/docker"
	"github.com/holla-world/typing-go-zero/tools/goctl/env"
	"github.com/holla-world/typing-go-zero/tools/goctl/gateway"
	"github.com/holla-world/typing-go-zero/tools/goctl/internal/cobrax"
	"github.com/holla-world/typing-go-zero/tools/goctl/internal/version"
	"github.com/holla-world/typing-go-zero/tools/goctl/kube"
	"github.com/holla-world/typing-go-zero/tools/goctl/migrate"
	"github.com/holla-world/typing-go-zero/tools/goctl/model"
	"github.com/holla-world/typing-go-zero/tools/goctl/quickstart"
	"github.com/holla-world/typing-go-zero/tools/goctl/rpc"
	"github.com/holla-world/typing-go-zero/tools/goctl/tpl"
	"github.com/holla-world/typing-go-zero/tools/goctl/upgrade"
